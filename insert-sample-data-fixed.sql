-- ===========================================
-- SAMPLE CASE STUDIES DATA (FIXED VERSION)
-- Jalankan di Supabase SQL Editor
-- ===========================================

-- Insert Case Study 1: Digital Advertising
...
-- Insert Case Study 2: Corporate Training
INSERT INTO case_studies (
  title, slug, client_name, client_logo_url, category_id,
  challenge, strategy, results,
  testimonial, testimonial_author, testimonial_position,
...
-- Insert Case Study 3: Growth Hacking
INSERT INTO case_studies (
  title, slug, client_name, client_logo_url, category_id,
  challenge, strategy, results,
  testimonial, testimonial_author, testimonial_position,
...
SELECT title, client_name, is_published FROM case_studies ORDER BY display_order;
