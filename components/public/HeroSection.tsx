...
export function HeroSection() {
  ...
  return (
    <div className="text-center py-16 px-8 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100 animate-fade-in relative overflow-hidden">
      ...
      <div className="relative z-10">
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight animate-scale-in">
          Studi Kasus<br />
