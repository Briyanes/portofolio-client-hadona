...
export function CTASection({ variant = 'home' }: CTASectionProps) {
  ...
  return (
    <section className="section-container py-16">
      <div className="bg-gradient-to-br from-hadona-primary via-hadona-dark to-hadona-bg-dark rounded-3xl p-12 text-center text-white shadow-2xl relative overflow-hidden animate-fade-in">
        {/* Background Pattern */}
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="btn-primary bg-hadona-yellow text-gray-900 hover:bg-hadona-yellow-dark group"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-bold rounded-xl border-2 border-white/30 hover:bg-white/20 transition-all hover:scale-105 inline-flex items-center gap-2"
            >
