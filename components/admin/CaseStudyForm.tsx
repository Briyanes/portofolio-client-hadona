  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      <Tabs defaultValue="basic">
        <TabsList className="bg-white rounded-xl shadow-md p-2">
          <TabsTrigger value="basic">📝 Informasi Dasar & Gambar</TabsTrigger>
      ...
      {/* Actions */}
      <div className="mt-8 flex items-center gap-3 justify-end bg-white rounded-xl shadow-md p-4">
        <Button
          type="button"
          variant="ghost"
